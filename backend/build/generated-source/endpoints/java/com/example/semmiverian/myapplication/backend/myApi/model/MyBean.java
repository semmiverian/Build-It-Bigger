...
package com.example.semmiverian.myapplication.backend.myApi.model;
...
public final class MyBean extends com.google.api.client.json.GenericJson {
  ...
  /**
   * @param listData listData or {@code null} for none
   */
  public MyBean setListData(java.util.List<java.lang.String> listData) {
